...
### Description
RP2040 DC motor speed controller targetting DRV-family motor drivers and supporting encoder-based speed correction. I²C can be used to set the desired speed.  
